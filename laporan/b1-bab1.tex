...
\begin{enumerate}
  ...
  \item Merancang skema penyimpanan, pengindeksan, dan \textit{retrieval} data agar sistem dapat memberikan jawaban relevan dan berbasis konteks.
\end{enumerate}
