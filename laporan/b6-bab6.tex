...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{logo-poliwangi}
...
\begin{lstlisting}[language=TeX, caption=Kode untuk Menyisipkan Gambar dalam Dokumen dengan Subfigure, label=lst:kode_gambar_multi]
    \begin{figure}
        ...
        \begin{subfigure}[b]{0.3\textwidth}
            \centering
            \includegraphics[width=\linewidth]{logo-poliwangi.png}
            \caption{Logo Poliwangi}
            \label{fig:logo-poliwangi-b}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.3\textwidth}
            \centering
...
\begin{packed_enum}
  ...
  \begin{packed_enum}
    ...
    \item Gambar kedua menggunakan file \texttt{logo-poliwangi}, dengan caption "Logo Poliwangi".
...
% Referensi dan sitasi pada dokumen \LaTeX juga cukup mudah. Silahkan buka file \textit{pustaka.bib} dan amati beberapa contoh penulisan referensi yang ada. Untuk menggenerate bentuk referensi seperti ini dapat menggunakan Mendeley atau Zotero. Mensitasi referensi seperti ini \citepp{Priambodo_2021}, \citepp{Nasuha_2017}, \citepp{Dhewa_Dharmawan_Priyambodo_2017}, \citepp{Arifin_2015} dapat dilakukan dengan perintah \verb|\citepp{nama_label}|. Pemberian sitasi dengan benar membuat sitasi tersebut dapat di klik dan akan mengarahkan ke daftar pustaka.